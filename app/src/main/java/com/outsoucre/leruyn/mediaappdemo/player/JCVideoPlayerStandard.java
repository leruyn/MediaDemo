 ...
 * On 2016/04/18 16:15
 */
public class JCVideoPlayerStandard extends JCVideoPlayer implements CompoundButton.OnCheckedChangeListener {
    ...
    public void init(Context context) {
        ...
        muteCheckbox = (CheckBox) findViewById(R.id.cb_mute);
...
//            titleTextView.setText(objects[1].toString());
    ...
    public void setAllControlsVisible(int topCon, int bottomCon, int startBtn, int loadingPro,
        ...
        muteCheckbox.setVisibility(bottomCon);
...
//            localLayoutParams.y = getContext().getResources().getDimensionPixelOffset(R.dimen.jc_volume_dialog_margin_left);
    ...
    public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        if(b){
            ...
            JCMediaManager.instance().setVolume(true);
            JCMediaManager.instance().mediaPlayer.start();
        }else{
            JCMediaManager.instance().mediaPlayer.pause();
            JCMediaManager.instance().setVolume(false);
            JCMediaManager.instance().mediaPlayer.start();
        }
    }
                ...
                if (getContext() != null && getContext() instanceof Activity) {
                    ((Activity) getContext()).runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            muteCheckbox.setVisibility(View.INVISIBLE);
